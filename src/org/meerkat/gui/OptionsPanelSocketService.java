...
public class OptionsPanelSocketService extends JPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1074428943057064795L;
	private SocketService webApp;
	 ...
	 * Create the panel.
	 */
	public OptionsPanelSocketService(final SocketService socketservice,
			final WebAppCollection wapCollection, MainWindow mw) {

		this.webApp = socketservice;
		...
		textField_groups.setBounds(122, 191, 392, 20);
		...
		button_save.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (new_name.equals("") || new_host.equals("")
					...
					webApp.setDataToSend(new_sendString);
	...
	public OptionsPanelSocketService() {
	}
