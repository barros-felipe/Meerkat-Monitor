...
public class SQL_MSSQL_Connector {
	...
	private static Logger log = Logger.getLogger(SQL_MSSQL_Connector.class);
	 ...
	 * @param password
	 */
	public SQL_MSSQL_Connector(String dbMachine, String port, String db,
	...
	public final String executeQuery(String query) {
		...
		try {
			conn = DriverManager.getConnection("jdbc:jtds:sqlserver://"
					+ dbMachine + ":" + port + "/" + db, username, password);
