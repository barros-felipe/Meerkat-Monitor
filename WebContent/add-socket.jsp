...
<html>
	<head>
		<title>Meerkat-Monitor - Add Socket</title>
							...
							<form name="settings" id="settings" action="" method="post">
								...
								<section class="box box-style1">
									...
									<div class="row">
										...
										<div class="2u">
											<input type="text" name="port" id="port" placeholder="Port" value=""/>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="4u">
											<input type="text" name="sendstr" id="sendstr" placeholder="Send string to socket" value=""/>
										</div>
									</div>
