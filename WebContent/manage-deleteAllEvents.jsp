...
<html>
	<head>
		<title>Meerkat-Monitor - Delete All Events</title>
				...
				<article class="5grid-layout" id="work">
					...
					<div class="5grid-layout">
						<section class="box box-style1">
							<h4><strong>Really want to delete all events?</strong></h4>
							<div>
								<span>
									<p>All events will be removed from Meerkat-Monitor! (Applications are kept)<br>
