...
<html>
	<head>
		...
		%>
		<title>Meerkat-Monitor - Delete Application - <%= appName %></title>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$("#confirm").click(function(){
					$("#buttons").hide();
					$("#msgbox").removeClass().addClass('info').html('Deleting application...<img src="images/loading.gif"> ').fadeIn(1000);
		...
		<div class="wrapper wrapper-style2">
				<article class="5grid-layout" id="work">
					<header>
						...
						<span>Delete <%= appName %></span>
					</header>
					<div class="5grid-layout">
						<section class="box box-style1">
							<h4><strong>Really want to delete "<%= appName %>"?</strong></h4>
							<div>
								<span>
									<p>"<%= appName %>" and their events will be deleted!<br>
