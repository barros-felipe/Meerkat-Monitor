...
<%
	...
	String sendstr = String.valueOf(request.getParameter("sendstr"));
	...
	String operationResult = addwebapp.addSocket(userInfo.getKey(), name, host, port, sendstr, expectedstring, executeoffline, groups, active);
